  ...
  return (
    <div>
          ...
          <div className="left-text">
            <div>
              ...
              <p style={{ marginBottom: "3rem" }}>
                We are the best <br /> web development company <br /> in the
                world
              </p>
              <div
                style={{
      ...
      <div className="container-sm" style={{ height: "100vh" }}>
        <OwlCarousel className="owl-themes" items={1} dots={true}>
          <div
            className="item"
            style={{ background: "rgb(237 237 237) !important" }}
          >
            <img src={First} alt="" />
          </div>
          <div className="item">
            <img
              src={second}
              alt=""
              style={{ background: "rgb(49 28 128) !important" }}
            />
          </div>
          <div className="item" style={{ background: "#141748" }}>
            <img src={third} alt="" />
          </div>
          <div className="item" style={{ background: "#0D131B !important" }}>
            <img src={Home} alt="" />
          </div>
          <div className="item" style={{ background: "#2DCDDD !important" }}>
            <img src={Fifth} alt="" />
          </div>
          <div
            className="item"
            style={{ background: "rgb(9 24 62) !important" }}
          >
            <img src={Sixth} alt="" />
          </div>
          <div className="item" style={{ background: "#00B769 !important" }}>
            <img src={Last} alt="" />
          </div>
        </OwlCarousel>
      </div>
